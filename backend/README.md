...
Essa seed irá garantir que sempre que for criando uma nova instância da API tenha pelo menos alguns dados cadastrados.
...
No `package.json` incluir o `script` para poder executar a seed
...
Execute a seed com o seguinte comando:
